...
private fun GoalPage(
    ...
    // 설정 화면(CupSizeSetting)의 실제 컵/텀블러 프리셋과 동일한 값 세트로 통일 — 임의의 라운드
    // 숫자 대신 종이컵(190)/유리컵(200)/스타벅스 톨·그란데·벤티(355/473/591)/메가커피(710)/
    // 생수(500)/스탠리 퀜처(887)를 그대로 재사용, 온보딩은 그룹 라벨·프리셋 이름 없이 ml만 표시
    val cupSizes = listOf(190, 200, 355, 473, 500, 591, 710, 887)
