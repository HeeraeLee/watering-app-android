...
enum class Achievement(
    ...
    STREAK_60("💎", R.string.achievement_streak_60_title, R.string.achievement_streak_60_message, isStreakBased = true),
    STREAK_100("🌟", R.string.achievement_streak_100_title, R.string.achievement_streak_100_message, isStreakBased = true),
    STREAK_365("🎇", R.string.achievement_streak_365_title, R.string.achievement_streak_365_message, isStreakBased = true)
}
