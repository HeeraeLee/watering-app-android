...
class AchievementCheckerTest {
    ...
    @Test
    fun check_목표달성하고streak가60이상이면_STREAK_60반환() = runTest {
        val prev = record(7, goal = 8)
        val next = record(8, goal = 8)
    ...
    @Test
    fun check_목표달성하고streak가100이상이면_STREAK_100반환() = runTest {
        val prev = record(7, goal = 8)
        val next = record(8, goal = 8)
    ...
    @Test
    fun check_목표달성하고streak가365이상이면_STREAK_365반환() = runTest {
        val prev = record(7, goal = 8)
        val next = record(8, goal = 8)
